...
legend({'Zrnic et al. (2022)', 'BoSSS - zero Init', 'BoSSS - 3. Order Init'}, 'Interpreter', 'latex', 'Fontsize', size_legend, 'Location', 'southeast')
xlabel('$t$', 'Interpreter', 'latex', 'FontSize', size_label)
xlim([0,4])
ylabel('$(0, 0)$', 'Interpreter', 'latex', 'FontSize', size_label)
set(gca, 'XTick', [0 1 2 3 4]) 
...
export_fig ModeDecomp_m4_Oh056_eta005_mode0.tif -r256
...
export_fig ModeDecomp_m4_Oh056_eta005_mode2.tif -r256
...
export_fig ModeDecomp_m4_Oh056_eta005_mode4.tif -r256
...
export_fig ModeDecomp_m4_Oh056_eta005_mode6.tif -r256
