...
legend({'$\eta = 0.1$', '$\eta = 0.2$', '$\eta = 0.3$', '$\eta = 0.4$', '$\eta = 0.5$', '$\eta = 0.6$', '$\eta = 0.7$'}, 'Interpreter', 'latex', 'Fontsize', size_legend, 'Location', 'southeast')
...
%export_fig modeDecomp6_m2_Oh01_FirstPeriodStudy.tif -r256
saveas(gcf, 'modeDecomp6_m2_Oh01_FirstPeriodStudy', 'epsc')
...
%export_fig modeDecomp6_m4_Oh01_FirstPeriodStudy.tif -r256
saveas(gcf, 'modeDecomp6_m4_Oh01_FirstPeriodStudy', 'epsc')
