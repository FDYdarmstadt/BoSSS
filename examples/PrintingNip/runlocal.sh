...
jupyter nbconvert --execute ./Part4_PrintingNip_SimulateUXMap_Run.ipynb --to html --output-dir ./PrintingNip/Output

jupyter nbconvert --execute ./Part6_PrintingNip_TearDown.ipynb --to html --output-dir ./PrintingNip/Output