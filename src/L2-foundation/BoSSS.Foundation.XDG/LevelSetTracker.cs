...
namespace BoSSS.Foundation.XDG {
    ...
    public partial class LevelSetTracker : IObservable<LevelSetTracker.LevelSetRegions>, IDisposable {
        ...
        /// </param>
        public LevelSetTracker(LevelSet levSet1, string SpeciesTableCode = "-:A +:B", XQuadFactoryHelper.MomentFittingVariants cutCellquadType = XQuadFactoryHelper.MomentFittingVariants.Saye, int __NearRegionWidth = 1) {
