...
namespace BoSSS.Foundation {
    ...
    public class ConstrainedDGField {
        ...
        public void ProjectDGField(ConventionalDGField DGField, CellMask mask = null) {
            ...
            //            NodeSet qNodes = getEdgeInterpolationNodes(NoCondAtVertices, NoCondAtGeomEdges);
            ...
            //Console.WriteLine("rank {0}: construct A*AT", this.m_grd.MpiRank);
            ...
            switch (m_grd.SpatialDimension) {
                ...
                case 3: {
                        if (numECond > degree) {
                            ...
                            QuadRule quad = m_grd.Edges.EdgeRefElements[0].GetQuadratureRule((degree - numECond) * 2);
                            return quad.Nodes;
                    }
                    }
                default:
