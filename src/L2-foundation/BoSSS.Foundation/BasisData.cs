...
namespace BoSSS.Foundation.Grid {
    ...
    /// <summary>
    /// Common, heavy-weighted data (e.g. evaluation caches, orthonormalization trafo, etc.) for all <see cref="Basis"/>-objects.
    /// </summary>
    public abstract class BasisData {
        ...
        /// ctor
        /// </summary>
        internal BasisData(IGridData o) {
            m_Owner = o;
        ...
        /// <summary>
        /// Returns the required orthonormalization transformation (for reference to physical elements) for each cell
        /// </summary>
        abstract protected MultidimensionalArray Compute_OrthonormalizationTrafo(int j0, int Len, int Degree);
        ...
        /// </summary>
        protected MultidimensionalArray EvaluateBasisGradient(NodeSet NS, int MinDegree) {
            int iKref = NS.GetVolumeRefElementIndex(this.m_Owner);
            int D = this.m_Owner.SpatialDimension;
        ...
        /// <summary>
        /// Cached evaluation of basis polynomials Hessian $\partial_{\vec{xi}}^2 \phi_n$ in reference space.
        /// </summary>
        ...
        /// </summary>
        protected MultidimensionalArray EvaluateBasisHessian(NodeSet NS, int MinDegree) {
            int iKref = NS.GetVolumeRefElementIndex(this.m_Owner);
            int D = this.m_Owner.SpatialDimension;
        ...
        /// <summary>
        /// Values of polynomials gradients in cells, $\partial^2_{\vec{x}} \phi_{j n}$
        /// </summary>
