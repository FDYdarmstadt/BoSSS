...
namespace BoSSS.Foundation {
    ...
    /// <param name="result">
    /// The output: 
    /// On exit, the value of the DG field at the given nodes are saved there.
    /// The array is 2-dimensional:
    ///  - 1st index: cell index <i>j</i> - <paramref name="j0"/>;
    ///  - 2nd index: node index <i>k</i>
    ...
    /// </remarks>
    public delegate void VectorFunctionEx(int j0, int Len, NodeSet nodes, MultidimensionalArray result);
}
