...
namespace BoSSS.Platform.Utils.Geom {
    ...
    public class BoundingBox : ICloneable {
        ...
        public double Distance(params double[] pt) {
            ...
            Vector3D _pt; _pt.x = 0; _pt.y = 0; _pt.z = 0;
            for (int d = 0; d < _D; d++) _pt[d] = pt[d];
            
            int NoOfVertice = 1; for (int d = _D - 1; d >= 0; d--) NoOfVertice *= 2; // number of vertices of the box
            ...
            for (int c = 0; c < NoOfVertice; c++) {
                ...
                for (int d = 0; d < _D; d++) {
                    int kase = cc / div;
                    switch (kase) {
                        case 0: vec[d] = this.Min[d]; break;
                        case 1: vec[d] = this.Max[d]; break;
                        default: throw new ApplicationException("error in alg");
                    }
    ...
    public struct GeomBinTreeBranchCode : IComparable<GeomBinTreeBranchCode> {
        ...
        public static GeomBinTreeBranchCode CreateFormPoint(BoundingBox bb, params double[] pt) {
            ...
            for (int level = 31; level >= 0; level--) {
                ...
                bool side = false; if (pt[cur_d] >= sep) side = true;
        ...
        /// comparison operator
        /// </summary>
        public static bool operator <(GeomBinTreeBranchCode a, GeomBinTreeBranchCode b) { return (a.Code < b.Code); }
        ...
        public static GeomBinTreeBranchCode Combine(GeomBinTreeBranchCode a, GeomBinTreeBranchCode b, out int commonBits) {
            GeomBinTreeBranchCode ret; ret.Code = 0;
