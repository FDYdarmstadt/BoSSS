...
typedef int (/*__stdcall*/ *HYPRE_PtrToParSolverFcn)(HYPRE_Solver,
                                       HYPRE_ParCSRMatrix,
                                       HYPRE_ParVector,
                                       HYPRE_ParVector);
 ...
 **/
int /*__stdcall*/ HYPRE_BoomerAMGSetup(HYPRE_Solver       solver,
 ...
 **/
int /*__stdcall*/ HYPRE_BoomerAMGSolve(HYPRE_Solver       solver,
                         HYPRE_ParCSRMatrix A,
                         HYPRE_ParVector    b,
                         HYPRE_ParVector    x);
 ...
 * @param x [OUT] approximated solution of the linear system to be solved
 **/
int /*__stdcall*/ HYPRE_BoomerAMGSolveT(HYPRE_Solver       solver,
                          HYPRE_ParCSRMatrix A,
                          HYPRE_ParVector    b,
                          HYPRE_ParVector    x);
 ...
 **/
int /*__stdcall*/ HYPRE_ParCSRDiagScaleSetup(HYPRE_Solver       solver,
                               HYPRE_ParCSRMatrix A,
                               HYPRE_ParVector    y,
                               HYPRE_ParVector    x);
 ...
 **/
int /*__stdcall*/ HYPRE_ParCSRDiagScale(HYPRE_Solver       solver,
