...
hypre_CGNRFunctionsCreate(
   ...
   int    (*ScaleVector)   ( double alpha, void *x ),
   int    (*Axpy)          ( double alpha, void *x, void *y ),
   int    (/*__stdcall*/ *PrecondSetup)  ( void *vdata, void *A, void *b, void *x ),
   int    (/*__stdcall*/ *Precond)       ( void *vdata, void *A, void *b, void *x ),
   int    (/*__stdcall*/ *PrecondT)       ( void *vdata, void *A, void *b, void *x )
   );
...
typedef struct
{
   ...
   int    (/*__stdcall*/ *precond)();
   int    (/*__stdcall*/ *precond_setup)();
...
int hypre_BiCGSTABSetPrecond ( void *bicgstab_vdata , int (/*__stdcall*/ *precond )(), int (/*__stdcall*/ *precond_setup )(), void *precond_data );
...
int hypre_CGNRSetPrecond ( void *cgnr_vdata , int (/*__stdcall*/ *precond )(void*,void*,void*,void*), int (/*__stdcall*/ *precondT )(void*,void*,void*,void*), int (/*__stdcall*/ *precond_setup )(void*,void*,void*,void*), void *precond_data );
...
int hypre_GMRESSetPrecond ( void *gmres_vdata , int (/*__stdcall*/ *precond )(), int (/*__stdcall*/ *precond_setup )(), void *precond_data );
...
int hypre_FlexGMRESSetPrecond ( void *fgmres_vdata , int (/*__stdcall*/ *precond )(), int (/*__stdcall*/ *precond_setup )(), void *precond_data );
...
int hypre_LGMRESSetPrecond ( void *lgmres_vdata , int (/*__stdcall*/ *precond )(), int (/*__stdcall*/ *precond_setup )(), void *precond_data );
...
int hypre_PCGSolve ( void *pcg_vdata , void *A , void *b , void *x , void (*dolog)());
...
int hypre_PCGSetPrecond ( void *pcg_vdata , int (/*__stdcall*/ *precond )(), int (/*__stdcall*/ *precond_setup )(), void *precond_data );
