...
//        double *w, double *work, int *lwork, int *info)  changed by fk: usual BLAS/FORTRAN subroutines have no return value
void  (*dsygv) (int *itype, char *jobz, char *uplo, int *
        n, double *a, int *lda, double *b, int *ldb,
...
utilities_FortranMatrix* r,
mv_MultiVectorPtr z,
//int (*dpotrf) (char *uplo, int *n, double *a, int *lda, int *info) changed by fk: usual BLAS/FORTRAN subroutines have no return value
