                ...
                void *x         )
{
   ...
   int          (/*__stdcall*/ *precond_setup)() = (cgnr_functions -> precond_setup);
                ...
                void *x         )
{
   ...
   int           (/*__stdcall*/ *precond)()   = (cgnr_functions -> precond);
   int           (/*__stdcall*/ *precondT)()  = (cgnr_functions -> precondT);
   void           *precond_data = (cgnr_data -> precond_data);
...
hypre_CGNRSetPrecond(void  *cgnr_vdata,
                     int  (/*__stdcall*/ *precond)(void*,void*,void*,void*),
                     int  (/*__stdcall*/ *precondT)(void*,void*,void*,void*),
                     int  (/*__stdcall*/ *precond_setup)(void*,void*,void*,void*),
                     void  *precond_data )
{
   hypre_CGNRData *cgnr_data = cgnr_vdata;
   hypre_CGNRFunctions *cgnr_functions = cgnr_data->functions;
