...
hypre_BCSRMatrixDenseBlockMultiply(hypre_BCSRMatrixDenseBlock* A,
  ...
  t = (double*) malloc(sizeof(double)*A->num_rows*A->num_cols);
...
//  double Bi[A->num_rows*A->num_cols];
  ...
  T = (double*) malloc(sizeof(double)*A->num_rows*A->num_cols);
  Bi = (double*) malloc(sizeof(double)*A->num_rows*A->num_cols);
...
hypre_BCSRMatrixDenseBlockTranspose(hypre_BCSRMatrixDenseBlock* A) {
  ...
  t = (double*) malloc(sizeof(double)*num_rows*num_cols);
...
hypre_BCSRMatrixDenseBlockNorm(hypre_BCSRMatrixDenseBlock* A,
  ...
  if(!strcmp(norm, "one")) {
	...
	col_sums = (double*) malloc(sizeof(double)*num_cols);
	...
	row_sums = (double*) malloc(sizeof(double)*num_rows);
