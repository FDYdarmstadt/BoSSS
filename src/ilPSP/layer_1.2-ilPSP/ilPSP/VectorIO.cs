...
namespace ilPSP.Utils {
    ...
    public static class VectorIO {
        ...
        /// <param name="list"></param>
        /// <param name="filename"></param>
        public static void SaveToTextFileDebugUnsteady<T>(this IEnumerable<T> list, string filename, string ext = ".txt", bool onlyRank0 = false) {
            int Rank;
        ...
        /// <param name="list"></param>
        /// <param name="filename"></param>
        public static void SaveToTextFileDebugUnsteady(this string str, string filename, string ext = "", bool onlyRank0 = false) {
            int Rank;
            MPI_Comm comm = csMPI.Raw._COMM.WORLD;
            csMPI.Raw.Comm_Rank(comm, out Rank);
            if (!onlyRank0 || Rank == 0) {
