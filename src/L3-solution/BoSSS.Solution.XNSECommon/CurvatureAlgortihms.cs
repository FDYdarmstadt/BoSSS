    ...
    public static class CurvatureAlgorithms {
            ...
            SinglePhaseField DG_LevSet) //
       {
        ...
        static void LaplaceBeltramiFiltered(LevelSetTracker LsTrk, 
            ...
            {
                XSpatialOperator op = new XSpatialOperator(DomName, Params, CodName, (int[] A, int[] B, int[] C) => HMForder);
                for(int d = 0; d < D; d++) {
            ...
            {
                XSpatialOperator qr = new XSpatialOperator(DomName, new string[] { "Curvature" }, CodName, (int[] A, int[] B, int[] C) => HMForder);
                for(int d = 0; d < D; d++) {
            ...
            VectorField<SinglePhaseField> surfaceForce ) //
        {
            ...
            XSpatialOperator xOp = new XSpatialOperator(domName, parameters, codName, (A,B,C) => HMForder);
