...
namespace BoSSS.Solution.XNSECommon.Operator.SurfaceTension {
    ...
    */
    ...
    public class IsotropicSurfaceTension_LaplaceBeltrami : IVolumeForm, IEdgeForm {
        ...
        public IsotropicSurfaceTension_LaplaceBeltrami(int d, int D, double sigma, IncompressibleBcType[] edgeTag2Type, IncompressibleBoundaryCondMap bcmap, double theta_e, double beta_L) {
            m_comp = d;
            m_D = D;
            m_sigma = sigma;
            m_theta = theta_e;
