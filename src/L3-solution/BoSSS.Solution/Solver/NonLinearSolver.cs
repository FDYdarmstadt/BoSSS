...
namespace BoSSS.Solution.Control {
    ...
    public enum NonLinearSolverCode {
        ...
        /// <summary>
        /// NewtonKrylov GMRES (<see cref="BoSSS.Solution.AdcancedSolvers.NonLinearSolver"/>) with linear solver (<see cref="LinearSolverCode"/>) used as preconditioner for matrix-free GMRES 
        /// </summary>
        NewtonGMRES = 0,
