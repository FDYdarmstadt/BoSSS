...
namespace BoSSS.Solution.Timestepping {
    ...
    public class RungeKuttaScheme : ICloneable {
        ...
        /// 2-stage 2nd order
        /// </summary>
        public static RungeKuttaScheme SDIRK_22 {
            get {
                RungeKuttaScheme ret = new RungeKuttaScheme();
                double x = 1.0 - Math.Sqrt(2.0) / 2.0;
                ret.a = new double[2, 2];
                ret.b = new double[2];
                ret.c = new double[2];
        ...
        /// 3-stage 2nd order
        /// </summary>
        public static RungeKuttaScheme ESDIRK_32 {
            get {
                RungeKuttaScheme ret = new RungeKuttaScheme();
                double x = (2.0 - Math.Sqrt(2.0)) / 2.0;
                ret.a = new double[3, 3];
                ret.b = new double[3];
                ret.c = new double[3];
                ...
                ret.a[1, 0] = x;
                ret.a[1, 1] = x;
                ret.a[2, 1] = (1.0 - 2.0 * x) / (4.0 * x);
                ret.a[2, 2] = x;
                ret.a[2, 0] = 1.0 - ret.a[2, 1] - ret.a[2, 2];
        ...
        /// 3-stage 3rd order
        /// </summary>
        public static RungeKuttaScheme SDIRK_33 {
            get {     
                return IMEX3;
            }
        }
        ...
        /// 4-stage 3th order
        /// </summary>
        public static RungeKuttaScheme SDIRK_43 {
            get {
                RungeKuttaScheme ret = new RungeKuttaScheme();
                double x = 9.0/40.0;
                ret.a = new double[4, 4];
                ...
                ret.c[0] = x;
                ret.a[0, 0] = x;
                ret.b[0] = 4032.0 / 9943.0;

                ret.c[1] = 7.0 / 13.0;
                ret.a[1, 0] = 163.0 / 520.0;
                ret.a[1, 1] = x;
                ret.b[1] = 6929.0 / 15485.0;
                
                ret.c[2] = 11.0 / 15.0;
                ret.a[2, 0] = -6481433.0 / 8838675.0;
                ret.a[2, 1] = 87795409.0 / 70709400.0;
                ret.a[2, 2] = x;
                ret.b[2] = -723.0 / 9272.0;

                ret.c[3] = 1.0;
                ret.a[3, 0] = 1.0 - ret.b[1] - ret.b[2] - x;
                ret.a[3, 1] = ret.b[1];
                ret.a[3, 2] = ret.b[2];
                ret.a[3, 3] = x;
                ret.b[3] = x;
        ...
        /// 5-stage 4th order
        /// </summary>
        public static RungeKuttaScheme SDIRK_54 {
            get {
                RungeKuttaScheme ret = new RungeKuttaScheme();
                double x = 0.25;
                ret.a = new double[5, 5];
                ...
                ret.c[1] = (2.0 - Math.Sqrt(2.0)) / 4.0;
                ret.a[1, 1] = x;
                ret.a[1, 0] = (1.0 - Math.Sqrt(2.0)) / 4.0;
                ret.b[1] = 4.0 * (74.0 + 273.0 * Math.Sqrt(2.0)) / 5253.0;

                ret.c[2] = (13.0 + 8.0 * Math.Sqrt(2.0)) / 41.0;
                ret.a[2, 2] = x;
                ret.a[2, 1] = 3.0 * (709.0 + 389.0 * Math.Sqrt(2.0)) / 6724.0;
                ret.a[2, 0] = (-1676.0 + 145.0 * Math.Sqrt(2.0)) / 6724.0;
                ret.b[2] = (19187.0 + 5031.0 * Math.Sqrt(2.0)) / 55284.0;

                ret.c[3] = (41.0 + 9.0 * Math.Sqrt(2.0)) / 49.0;
                ret.a[3, 3] = x;
                ret.a[3, 2] = (56061972.0 + 30241643.0 * Math.Sqrt(2.0)) / 112001848.0;
                ret.a[3, 1] = (98054928.0 + 73894543.0 * Math.Sqrt(2.0)) / 112001848.0;
                ret.a[3, 0] = (-371435.0 - 351111.0 * Math.Sqrt(2.0)) / 470596.0;
                ret.b[3] = (116092.0 - 100113.0 * Math.Sqrt(2.0)) / 334956.0;
        ...
        /// Note, that in BoSSS this is purely implicit, as we do not employ a "splitting" of convective and diffusive Terms (as of 09/2021)
        /// </remarks>
