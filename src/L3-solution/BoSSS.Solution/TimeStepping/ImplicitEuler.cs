...
namespace BoSSS.Solution.Timestepping {
    ...
    public class ImplicitEuler : ImplicitTimeStepper {
        ...
        /// See <see cref="ImplicitTimeStepper"/>
        /// </summary>
        public ImplicitEuler(ISparseSolverExt solver, DifferentialOperator spatialOp, CoordinateMapping fields)
            : this(solver, AllTrue(fields.Fields.Count), spatialOp, fields) { }

        /// <summary>
        /// See <see cref="ImplicitTimeStepper"/>
        /// </summary>
        public ImplicitEuler(ISparseSolverExt solver, bool[] temporalOp, DifferentialOperator spatialOp, CoordinateMapping fields)
            : base(solver, temporalOp, spatialOp, fields) { }

        /// <summary>
        /// See <see cref="ImplicitTimeStepper"/>
        /// </summary>
        public ImplicitEuler(ISparseSolverExt solver, DifferentialOperator spatialOp, params DGField[] fields)
            : this(solver, AllTrue(fields.Length), spatialOp, fields) { }

        /// <summary>
        /// See <see cref="ImplicitTimeStepper"/>
        /// </summary>
        public ImplicitEuler(ISparseSolverExt solver, bool[] temporalOp, DifferentialOperator spatialOp, params DGField[] fields)
