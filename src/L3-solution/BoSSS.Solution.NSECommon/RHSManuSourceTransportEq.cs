...
namespace BoSSS.Solution.NSECommon {
    ...
    public class RHSManuSourceTransportEq : BoSSS.Solution.Utils.LinearSource {
        ...
        protected override double Source(double[] x, double[] parameters, double[] U) {
            ...
            ConvectionTerm = Math.Cos(x_) * p0 * Math.Pow(alpha1 * Math.Cos(x_ * y_) / M1 + alpha2 * Math.Cos(x_ * y_) / M2 + alpha3 * Math.Cos(x_ * y_) / M3 + (0.10e1 - Math.Cos(x_ * y_)) / M4, -0.2e1) * (-alpha1 * y_ * Math.Sin(x_ * y_) / M1 - alpha2 * y_ * Math.Sin(x_ * y_) / M2 - alpha3 * y_ * Math.Sin(x_ * y_) / M3 + y_ * Math.Sin(x_ * y_) / M4) + p0 / (alpha1 * Math.Cos(x_ * y_) / M1 + alpha2 * Math.Cos(x_ * y_) / M2 + alpha3 * Math.Cos(x_ * y_) / M3 + (0.10e1 - Math.Cos(x_ * y_)) / M4) * Math.Sin(x_) + Math.Cos(y_) * p0 * Math.Pow(alpha1 * Math.Cos(x_ * y_) / M1 + alpha2 * Math.Cos(x_ * y_) / M2 + alpha3 * Math.Cos(x_ * y_) / M3 + (0.10e1 - Math.Cos(x_ * y_)) / M4, -0.2e1) * (-alpha1 * x_ * Math.Sin(x_ * y_) / M1 - alpha2 * x_ * Math.Sin(x_ * y_) / M2 - alpha3 * x_ * Math.Sin(x_ * y_) / M3 + x_ * Math.Sin(x_ * y_) / M4) + p0 / (alpha1 * Math.Cos(x_ * y_) / M1 + alpha2 * Math.Cos(x_ * y_) / M2 + alpha3 * Math.Cos(x_ * y_) / M3 + (0.10e1 - Math.Cos(x_ * y_)) / M4) * Math.Sin(y_);
