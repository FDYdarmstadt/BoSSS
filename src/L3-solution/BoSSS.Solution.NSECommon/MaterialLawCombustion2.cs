...
namespace BoSSS.Solution.NSECommon {
    ...
    /// </summary>
    public class MaterialLawCombustion2 : MaterialLawLowMach {
        ...
        public MaterialLawCombustion2(double T_ref_Sutherland, double[] MolarMasses, MaterialParamsMode MatParamsMode, bool rhoOne, bool _cpOne, double gasConstant, double Prandtl)
            : base(T_ref_Sutherland, MatParamsMode, rhoOne, _cpOne,Prandtl) {
        ...
        /// <summary>
        /// Density evaluation for a multicomponent ideal fluid
        /// </summary>
        /// <param name="p0">
        /// The thermodynamic pressure, constant in time for an open system, and time dependant of a closed system
        /// </param>
        /// <param name="phi">
        /// Array of scalars (temperature and mass fractions) used for calculating the density.
        /// </param>
        /// <returns></returns>
        public override double GetDensity(double p0, params double[] phi) {
            double rho;
            if (!base.rhoOne) {
                if (phi.Length < 2)
                    throw new ArgumentException("Error in density computation. Number of chemical component needs to be atleast 1.");
