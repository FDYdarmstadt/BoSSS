...
namespace BoSSS.Solution.NSECommon
{
    ...
    // /// </summary>
    // [Obsolete]
    // public class __LinearizedScalarConvection : LinearFlux
    // {
    ...
    //     /// Has to be given for Low-Mach to calculate density.
    //     /// </param>
    //     public __LinearizedScalarConvection(int SpatDim, IncompressibleBoundaryCondMap BcMap, MaterialLaw EoS)
    //     {
    ...
    //     /// intended for use in the context of RANS turbulence model equations
    //     /// </summary>
    //     public __LinearizedScalarConvection(int SpatDim, IncompressibleBoundaryCondMap BcMap, string TurbulentVariable, string TurbulentVariable0, string TurbulentVariable0Mean)
    //     {
    //         if (BcMap.PhysMode != PhysicsMode.RANS)
    //         {
    //             throw new ApplicationException("This Constructor is only intended for RANS turbulence model equations");
