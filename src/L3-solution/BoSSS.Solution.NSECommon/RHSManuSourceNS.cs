...
namespace BoSSS.Solution.NSECommon {
    ...
    public class RHSManuSourceNS : BoSSS.Solution.Utils.LinearSource {
        ...
        /// </summary>
        public RHSManuSourceNS(double Reynolds, double[] MolarMasses, string direction) {
        ...
        protected override double Source(double[] x, double[] parameters, double[] U) {
            ...
            if (direction == "x") {
                ...
                ViscTerm = -0.4e1 / 0.3e1 * Math.Cos(x_) / Reynolds;
                PressureGradientTerm = y_ * Math.Cos(x_ * y_);
            }
            else if (direction == "y") {
