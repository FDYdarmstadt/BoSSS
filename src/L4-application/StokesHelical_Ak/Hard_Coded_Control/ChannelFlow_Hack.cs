...
namespace StokesHelical_Ak {
    internal class ChannelFlow_Hack {

        /// <summary>
        /// Centrifuge flow (aka. flow in a rotating pipe)
        /// </summary>
        public static HelicalControl TestingArae(string _DbPath = null, int degree = 3, int noOfCellsR = 64, int noOfCellsXi = 64, int bdfOrder = 3, int numOfTimesteps = 1, double deltaT = 1, double rMin = 0, double MaxAmp = 5, double rMax =1) {
            ...
            Ctrl.AddBoundaryValue("Dirichlet_inner_wall", "Pressure", new Formula("(X,t) =>0", true));
            #endregion
