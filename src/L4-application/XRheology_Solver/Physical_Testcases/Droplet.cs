...
namespace BoSSS.Application.XRheology_Solver {
    ...
    public static class Droplet {
        ...
        /// </summary>
        /// <returns></returns>
        public static XRheology_Control StaticDroplet_Free(int p = 2, int kelem = 16, string _DbPath = null) {
            ...
            C.ProjectName = "XRheology/Droplet";
        ...
        /// </summary>
        /// <returns></returns>
        public static XRheology_Control OscillatingDroplet(int p = 2, int kelem = 40, string _DbPath = null) {
        ...
        /// </summary>
        /// <returns></returns>
        public static XRheology_Control TheKartoffel(int p = 2, string _DbPath = null) {
        ...
        /// </summary>
        /// <returns></returns>
        public static XRheology_Control CollidingDroplets(int p = 1, int kelem = 16, string _DbPath = null) {
        ...
        /// </summary>
        /// <returns></returns>
        public static XRheology_Control SD_SurfaceTensionTest(int p = 2, int kelem = 20, string _DbPath = null) {
        ...
        /// </summary>
        /// <returns></returns>
        public static XRheology_Control OscillatingDroplet_AMRtest(int p = 2, int kelem = 20) {
        ...
        /// </summary>
        /// <returns></returns>
        public static XRheology_Control DropletOnPlate_AMRtest(int p = 2, int kelem = 16) {
            ...
            //C.LogValues = XRheology_Control.LoggingValues.MovingContactLine;
            ...
            C.AdaptiveMeshRefinement = true;
            C.RefineStrategy = XRheology_Control.RefinementStrategy.ContactLineRefined;
            C.RefinementLevel = 1;
