...
namespace BoSSS.Solution.RheologyCommon {
    ...
    public static partial class XConstitutiveOperatorComponentsFactory {
        ...
        public static void AddSpeciesConstitutive_component(XSpatialOperatorMk2 XOp, INSE_Configuration config, int compRow, int compCol, int D, int stressDegree, string spcName, SpeciesId spcId,
        ...
        /// <param name="LsTrk"></param>
        /// <param name="U0meanrequired"></param>
        public static void AddSpeciesConstitutive(XSpatialOperatorMk2 XOp, INSE_Configuration config, int compRow, int compCol, int D, int stressDegree, string spcName, SpeciesId spcId,
            IncompressibleMultiphaseBoundaryCondMap BcMap, LevelSetTracker LsTrk, out bool U0meanrequired) {
