...
namespace BoSSS.Solution.RheologyCommon {
    ...
    public static partial class XConstitutiveOperatorComponentsFactory {
        ...
        public static void AddSpeciesNSE_component(XSpatialOperatorMk2 XOp, INSE_Configuration config, int compRow, int compCol, int D, string spcName, SpeciesId spcId, 
           ...
           // }
            ...
            // convective operator
            // ===================
            var convective = new ConvectiveInBulk(compRow, compCol, BcMap, )
                ...
                switch(dntParams.ViscosityMode) {
                    ...
                    case ViscosityMode.Viscoelastic: {
                            ...
                            var Visc1 = new Operator.Viscosity.DimensionlessViscosityInSpeciesBulk_GradUTerm(
                                dntParams.UseGhostPenalties ? 0.0 : penalty, 1.0,
                                BcMap, spcName, spcId, d, D, physParams.reynolds_A / physParams.beta, physParams.reynolds_B / physParams.beta);
                            comps.Add(Visc1);
