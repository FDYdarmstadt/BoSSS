...
{
    public class ScalarAdvectionRHFlux_Interface : ILevelSetForm, ILevelSetEquationComponentCoefficient {
        ...
        public ScalarAdvectionRHFlux_Interface(LevelSetTracker levelSetTracker, int levelSetIndex = 0, string posSpecies = "R", string negSpecies = "L") {
        ...
        public ScalarAdvectionRHFlux_Interface(LevelSetTracker lsTrk, Func<double, double> FlowFunc, int levelSetIndex = 0, string posSpecies = "R", string negSpecies = "L") {
            this.lsTrk = lsTrk;
        ...
        public ScalarAdvectionRHFlux_Interface(double a) {
            this.a = a;
        }
    }
