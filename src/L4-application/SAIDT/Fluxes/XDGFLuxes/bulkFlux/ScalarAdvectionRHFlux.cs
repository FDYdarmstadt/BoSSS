...
namespace SAIDT.Fluxes {
    class ScalarAdvectionRHFlux : ISpeciesFilter, IEdgeForm {
        public double cL;
        public double cR;
        public double x0;
        ...
        public ScalarAdvectionRHFlux(string spc, double x0, double cL, double cR, Func<double, double> FlowFunc, Func<double[], double> bndrymap) {
            this.cL = cL;
            this.cR = cR;
            this.spc = spc;
            this.x0 = x0;
        ...
        protected double InnerEdgeFlux(double time, double[] x, double[] normal, double[] Uin, double[] Uout, int jEdge) {
            ...
            var flowfield = FlowField(x);
            return flowfield * (Uin[0] - Uout[0]) * n;
        }
