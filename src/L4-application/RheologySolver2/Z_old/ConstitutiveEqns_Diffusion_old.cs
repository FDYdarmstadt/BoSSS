...
namespace BoSSS.Application.Rheology {
    ...
    class ConstitutiveEqns_Diffusion_old : BoSSS.Solution.NSECommon.SIPLaplace {

        public ConstitutiveEqns_Diffusion_old(int order, int dimension, MultidimensionalArray cj, string variable) :
