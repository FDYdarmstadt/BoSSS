...
namespace BoSSS.Application.Rheology {
    ...
    public class StressDivergence_Cockburn_old : LinearFlux {
        ...
        /// </summary>
        public StressDivergence_Cockburn_old(int Component, BoundaryCondMap<IncompressibleBcType> _BcMap, double Reynolds, double[] Penalty1, double Penalty2) {
