...
namespace BoSSS.Application.Rheology {
    ...
    /// </summary>
    public static class ArtificialViscosity_old {

        /// <summary>
        /// calculating the value of the artificial viscosity
        /// </summary>
        public static double GetViscosity_old(int jCell, double cellSize, int dgDegree, double perssonSensor, double sensorLimit, double maxViscosity) {
        ...
        /// </summary>
        public static void ProjectArtificalViscosityToDGField(SinglePhaseField avField, PerssonSensor_old sensor, double sensorLimit, double maxViscosity, CellMask cellMask = null) {
            ...
            foreach (int cell in cellMask.ItemEnum) {
                ...
                double localViscosity = GetViscosity_old(cell, h_min[cell], p, sensor.GetValue(cell), sensorLimit, maxViscosity);
