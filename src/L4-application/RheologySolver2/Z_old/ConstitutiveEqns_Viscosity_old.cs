...
namespace BoSSS.Application.Rheology {
    ...
    /// </summary>
    public class ConstitutiveEqns_Viscosity_old : IVolumeForm, IEdgeForm, ISupportsJacobianComponent {
        ...
        /// </summary>
        public ConstitutiveEqns_Viscosity_old(int Component, BoundaryCondMap<IncompressibleBcType> _BcMap, double beta, double[] Penalty1) {
