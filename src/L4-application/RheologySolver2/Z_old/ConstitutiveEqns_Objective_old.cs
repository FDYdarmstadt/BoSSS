...
namespace BoSSS.Application.Rheology {
    ...
    /// </summary>
    public class ConstitutiveEqns_Objective_old : IVolumeForm, IEquationComponent, IEquationComponentCoefficient, ISupportsJacobianComponent  {
        ...
        /// </summary>
        public ConstitutiveEqns_Objective_old(int Component, BoundaryCondMap<IncompressibleBcType> _BcMap, double Weissenberg, double ObjectiveParam, double Penalty)
        {
        ...
        class OwnerCaller : IEdgeForm {
            public OwnerCaller(ConstitutiveEqns_Objective_old __owner) {
                owner = __owner;
            }
            ConstitutiveEqns_Objective_old owner;
