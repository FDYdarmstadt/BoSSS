...
namespace BoSSS.Application.XNSERO_Solver {
    ...
    public class InitializeMotion {
        ...
        /// </param>
        public InitializeMotion(double particleDensity = 0, bool isDry = false, bool noRotation = false, bool noTranslation = false, double addedDampingCoefficient = 0, bool calculateOnlyVelocity = false) {
        ...
        public Motion ParticleMotion {
            get {
                ...
                if (addedDampingCoefficient != 0)
                    return new MotionAddedDamping(particleDensity, addedDampingCoefficient);
                else
