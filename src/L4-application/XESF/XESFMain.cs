...
namespace XESF {
        ...
        protected override void CreateEquationsAndSolvers(BoSSS.Solution.LoadBalancing.GridUpdateDataVaultBase L) {
            ...
            if(Control.FluxVersion == FluxVersion.NonOptimized) {
                ...
                case OptProblemType.RankineHugoniotOnlyInterface:
                    if(Control.optProblemType== OptProblemType.RankineHugoniotFull){ // add a Bulk Flux 
                        foreach(SpeciesId id in SpeciesToEvaluate_Ids) {
                            string spcNmn = LsTrk.GetSpeciesName(id);
                        ...
                        case true:
                            ...
                            //this.Op_obj.EquationComponents[CompressibleVariables.Density].Add(new XESF.Fluxes.OptimizedHLLCDensityFlux_XDG_Wall(LsTrk, boundaryMap, material, XESF.Fluxes.FluxVariables.Density, levelSetIndex: 0, negSpecies: Control.LsOne_NegSpecies, posSpecies: Control.LsOne_PosSpecies));
                            //this.Op_obj.EquationComponents[CompressibleVariables.Momentum.xComponent].Add(new XESF.Fluxes.OptimizedHLLCMomentumFlux_XDG_Wall(LsTrk, boundaryMap, material, XESF.Fluxes.FluxVariables.Momentum, 0, levelSetIndex: 0, negSpecies: Control.LsOne_NegSpecies, posSpecies: Control.LsOne_PosSpecies));
                            //this.Op_obj.EquationComponents[CompressibleVariables.Momentum.yComponent].Add(new XESF.Fluxes.OptimizedHLLCMomentumFlux_XDG_Wall(LsTrk, boundaryMap, material, XESF.Fluxes.FluxVariables.Momentum, 1, levelSetIndex: 0, negSpecies: Control.LsOne_NegSpecies, posSpecies: Control.LsOne_PosSpecies));
                            //this.Op_obj.EquationComponents[CompressibleVariables.Energy].Add(new XESF.Fluxes.OptimizedHLLCEnergyFlux_XDG_Wall(LsTrk, boundaryMap, material, XESF.Fluxes.FluxVariables.Energy, levelSetIndex: 0, negSpecies: Control.LsOne_NegSpecies, posSpecies: Control.LsOne_PosSpecies));
            ...
            //    TimeStepConstraints.Add(new ConvectiveXDGCFLConstraint(LsTrk, LsTrk.GetAgglomerator(SpeciesToEvaluate_Ids, Control.NonlinearQuadratureDegree, Control.AgglomerationThreshold), SpeciesToEvaluate_Ids[1], 1, ConservativeFields, gridData, Control));
            //} else {
            //    TimeStepConstraints.Add(new ConvectiveXDGCFLConstraint(LsTrk, LsTrk.GetAgglomerator(SpeciesToEvaluate_Ids, Control.NonlinearQuadratureDegree, Control.AgglomerationThreshold), SpeciesToEvaluate_Ids[0], 0, ConservativeFields, gridData, Control));
            //}

            // TimeSteppingScheme scheme;
            // switch(Control.TimeSteppingScheme) {
            //     case TimeSteppingSchemes.XdgRK:
            //     scheme = TimeSteppingScheme.RK1;
            //     break;
            //     case TimeSteppingSchemes.XdgBDF:
            //     scheme = TimeSteppingScheme.ImplicitEuler;
            //     break;
            //     default: throw new NotImplementedException();
            // }

            //this.XdgTimestepping = new XdgTimestepping(
            //    this.XSpatialOperator,
            //    this.ConservativeFields, this.Residuals,
            //    scheme,
            //    null, LevelSetHandling.None,
            //    this.MultigridOperatorConfig, base.MultigridSequence, this.Control.AgglomerationThreshold,
    ...
    /// <summary>
    /// Runs test cases from all IDTSolvers shown in a publication (except BowShock, because takes to long)
    /// </summary>
    public static class JakobsTestRunner {
