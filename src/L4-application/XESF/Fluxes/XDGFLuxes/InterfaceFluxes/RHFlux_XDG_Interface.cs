...
namespace XESF.Fluxes {
    public class RHFlux_XDG_Interface: ILevelSetForm, IEquationComponentChecking, ISupportsJacobianComponent {
        ...
        public RHFlux_XDG_Interface(IBoundaryConditionMap boundaryConditionMap, Material material, FluxVariables flux, int component = int.MinValue, int levelSetIndex = 0, string posSpecies = "R", string negSpecies = "L") {
            //this.levelSetTracker = levelSetTracker;

            switch(flux) {
                case FluxVariables.Density:
                this.bulkFlux = new RHDensityFlux(boundaryConditionMap, material);
                break;
                case FluxVariables.Momentum:
                this.bulkFlux = new RHMomentumFlux(boundaryConditionMap, material, component);
                break;
                case FluxVariables.Energy:
                this.bulkFlux = new RHEnergyFlux(boundaryConditionMap, material);
                break;
                default:
        ...
        protected readonly RHFlux bulkFlux;
