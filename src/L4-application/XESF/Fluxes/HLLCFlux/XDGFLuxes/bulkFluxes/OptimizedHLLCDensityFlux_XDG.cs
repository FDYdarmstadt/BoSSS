...
namespace XESF.Fluxes {
    ...
    public class OptimizedHLLCDensityFlux_XDG : OptimizedHLLCDensityFlux, ISpeciesFilter {

        private SpeciesId speciesId;

        public OptimizedHLLCDensityFlux_XDG(IBoundaryConditionMap boundaryMap, Material material, string spcName, SpeciesId speciesId) : base(boundaryMap, material) {
