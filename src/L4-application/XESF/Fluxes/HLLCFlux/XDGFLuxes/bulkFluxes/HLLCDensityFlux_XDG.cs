...
namespace XESF.Fluxes {
    ...
    public class HLLCDensityFlux_XDG : HLLCDensityFlux, ISpeciesFilter {

        private SpeciesId speciesId;

        public HLLCDensityFlux_XDG(IBoundaryConditionMap boundaryMap, Material material, string spcName, SpeciesId speciesId) : base(boundaryMap, material) {
