...
namespace XESF.Fluxes {
    ...
    public class HLLCMomentumFlux_XDG : HLLCMomentumFlux, ISpeciesFilter {

        private SpeciesId speciesId;

        public HLLCMomentumFlux_XDG(IBoundaryConditionMap boundaryMap, int component, Material material, string spcName, SpeciesId speciesId) : base(boundaryMap, component, material) {
