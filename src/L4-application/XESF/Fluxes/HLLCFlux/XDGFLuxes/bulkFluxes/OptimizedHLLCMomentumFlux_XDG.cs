...
namespace XESF.Fluxes {
    ...
    public class OptimizedHLLCMomentumFlux_XDG : OptimizedHLLCMomentumFlux, ISpeciesFilter {

        private SpeciesId speciesId;

        public OptimizedHLLCMomentumFlux_XDG(IBoundaryConditionMap boundaryMap, int component, Material material, string spcName, SpeciesId speciesId) : base(boundaryMap, component, material) {
