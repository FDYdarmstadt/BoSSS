...
namespace XESF.Fluxes {
    public class OptimizedHLLCEnergyFlux_XDG_Wall : ILevelSetForm, INonlinLevelSetForm_V, IEquationComponentChecking {
        ...
        public double InnerEdgeForm(ref CommonParams inp, double[] uA, double[] uB, double[,] Grad_uA, double[,] Grad_uB, double vA, double vB, double[] Grad_vA, double[] Grad_vB) {
            ...
            //// StreamWriter
            //if (writer == null) {
            //    writer = new StreamWriter("XDG_Flux_rhoE.txt");
        ...
        public OptimizedHLLCEnergyFlux_XDG_Wall(LevelSetTracker levelSetTracker, IBoundaryConditionMap boundaryConditionMap, Material material, FluxVariables flux, int levelSetIndex = 0, string posSpecies = "B", string negSpecies = "A") {
