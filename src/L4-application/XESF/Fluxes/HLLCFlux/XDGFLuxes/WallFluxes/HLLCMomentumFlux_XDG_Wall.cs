...
namespace XESF.Fluxes {
    public class HLLCMomentumFlux_XDG_Wall : ILevelSetForm, ISupportsJacobianComponent {
        ...
        public HLLCMomentumFlux_XDG_Wall(LevelSetTracker levelSetTracker, IBoundaryConditionMap boundaryConditionMap, Material material, FluxVariables flux, int component = int.MinValue, int levelSetIndex = 0, string posSpecies = "B", string negSpecies = "A") {
