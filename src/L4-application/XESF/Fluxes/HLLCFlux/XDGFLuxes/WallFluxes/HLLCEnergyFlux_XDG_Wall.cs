...
namespace XESF.Fluxes {
    public class HLLCEnergyFlux_XDG_Wall : ILevelSetForm, ISupportsJacobianComponent {
        ...
        public HLLCEnergyFlux_XDG_Wall(LevelSetTracker levelSetTracker, IBoundaryConditionMap boundaryConditionMap, Material material, FluxVariables flux, int levelSetIndex = 0, string posSpecies = "B", string negSpecies = "A") {
