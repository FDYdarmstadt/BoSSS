...
namespace XESF.Fluxes {
    public class OptimizedHLLCMomentumFlux_XDG_Wall : ILevelSetForm, INonlinLevelSetForm_V, IEquationComponentChecking {
        ...
        public double InnerEdgeForm(ref CommonParams inp, double[] uA, double[] uB, double[,] Grad_uA, double[,] Grad_uB, double vA, double vB, double[] Grad_vA, double[] Grad_vB) {
            ...
            //int D = this.levelSetTracker.GridDat.SpatialDimension;
            int D = inp.D;
            ...
            //// StreamWriter
            //if (writer == null) {
            //    writer = new StreamWriter("XDG_Flux_m.txt");
        ...
        public OptimizedHLLCMomentumFlux_XDG_Wall(LevelSetTracker levelSetTracker, IBoundaryConditionMap boundaryConditionMap, Material material, FluxVariables flux, int component = int.MinValue, int levelSetIndex = 0, string posSpecies = "B", string negSpecies = "A") {
