...
namespace XESF.Fluxes {
    public class RoeFlux_XDG_Wall : ILevelSetForm, ISupportsJacobianComponent,IEquationComponentChecking {
        ...
        public RoeFlux_XDG_Wall(LevelSetTracker levelSetTracker, IBoundaryConditionMap boundaryConditionMap, Material material, FluxVariables flux, int component, int levelSetIndex , string posSpecies , string negSpecies , double s_alpha,int D=2) {
