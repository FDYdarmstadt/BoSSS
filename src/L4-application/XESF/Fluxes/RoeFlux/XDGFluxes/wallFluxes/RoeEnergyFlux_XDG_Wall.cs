...
namespace XESF.Fluxes {
    public class RoeEnergyFlux_XDG_Wall : ILevelSetForm, ISupportsJacobianComponent, IEquationComponentChecking {
        ...
        private (Vector vAverage, double speedOfSoundAverage, double enthalpyAverage, double[] eigenVals, MultidimensionalArray V0_inv, double[] uWall) Setup(ref CommonParams inp, double[] uA, double[] uB) {
        ...
        /* //right now this method is not used
        ...
        */
        ...
        public RoeEnergyFlux_XDG_Wall(LevelSetTracker levelSetTracker, IBoundaryConditionMap boundaryConditionMap, Material material, FluxVariables flux, int levelSetIndex = 0, string posSpecies = "B", string negSpecies = "A") {
