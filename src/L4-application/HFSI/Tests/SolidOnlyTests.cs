...
//            controlFiles.Add(HFSISolver.ControlFiles.Vortex.SteadyVortex(p, 4));
...
//            // --test=HFSISolver.Tests.SolidOnlyTests.RunSolver
//            BoSSS.Solution.Application.DeleteOldPlotFiles();
//            var C = HFSISolver.ControlFiles.Vortex.UnsteadyVortex(p, res);
