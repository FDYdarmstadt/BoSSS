...
namespace HFSISolver {
    class HFSImain {
        ...
        static void RunSolver(string[] args) {
            //Debugger.Launch();
            HFSI._Main(args, false, delegate () {
        ...
        static void ConditionNumberScaling(int p = 2,
            ...
            List<ZLS_Control> controlFiles = new List<ZLS_Control> {
                HFSISolver.ControlFiles.Vortex.SteadyVortex(p, 8),
                HFSISolver.ControlFiles.Vortex.SteadyVortex(p, 16),
                HFSISolver.ControlFiles.Vortex.SteadyVortex(p, 32)
            };
            //controlFiles.Add(HFSISolver.ControlFiles.Vortex.SteadyVortex(p, 64));
        ...
        */
        ...
        static void ConvergenceNumberScaling(int p = 2,
            ...
            controlFiles.Add(HFSISolver.ControlFiles.Vortex.SteadyVortex(p, 8));
            controlFiles.Add(HFSISolver.ControlFiles.Vortex.SteadyVortex(p, 16));
            controlFiles.Add(HFSISolver.ControlFiles.Vortex.SteadyVortex(p, 32));
            //controlFiles.Add(HFSISolver.ControlFiles.Vortex.SteadyVortex(p, 64));
