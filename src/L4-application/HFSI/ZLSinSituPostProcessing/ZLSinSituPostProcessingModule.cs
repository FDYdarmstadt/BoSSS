...
namespace HFSISolver.ZLSinSituPostProcessing
{
    /// <summary>
    ...
    public abstract class ZLSinSituPostProcessingModule : InSituPostProcessingModule
    {
        ...
        /// control object
        /// </summary>
        new protected HFSI_Control Control
        {
            get
            {
                return (HFSI_Control)(base.Control);
            }
        }
        ...
        protected XDGField[] CurrentVel
        {
            get
            {
                if (this.SolverMain is HFSI solver)
                {
        ...
        protected int m_HMForder
        {
            get
            {
                ...
                if (this.SolverMain is XNSE<HFSI_Control> solver)
                {
        ...
        protected FourierLevSetBase Fourier_LevSet
        {
            get
            {
                if (base.SolverMain is HFSI newSolver)
                {
