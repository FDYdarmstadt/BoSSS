...
using HFSISolver.ZLSinSituPostProcessing;

namespace HFSISolver.ControlFiles {
    public static class ConvergenceTests {
        public static HFSI_Control RycroftPaper(int p = 2, int kelem = 16) {
        ...
        public static HFSI_Control SimpleTransport(int p = 2, int kelem = 18) {
            HFSI_Control C = new HFSI_Control(p);
        ...
        public static HFSI_Control SimpleConvergence(int p = 2, int kelem = 18) {
            HFSI_Control C = new HFSI_Control(p);
            C.ImmediatePlotPeriod = 1;
            C.SuperSampling = 4;
            C.AgglomerationThreshold = 0.3;
        ...
        public static HFSI_Control SteadyBeam(int p = 2, int kelem = 6, int AMRlvl = 0) {
            HFSI_Control C = new HFSI_Control(p);
            C.ImmediatePlotPeriod = 1;
            C.SuperSampling = 4;
        ...
        public static HFSI_Control SimpleDivergencefree(int p = 2, int kelem = 16, int AMRlvl = 0) {
            HFSI_Control C = new HFSI_Control(p);
            ...
            C.AdvancedDiscretizationOptions.FilterConfiguration = BoSSS.Solution.LevelSetTools.CurvatureAlgorithms.FilterConfiguration.NoFilter;
            C.AdvancedDiscretizationOptions.ViscosityMode = ViscosityMode.Standard;
