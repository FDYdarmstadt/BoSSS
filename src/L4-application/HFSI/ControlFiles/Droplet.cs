...
namespace HFSISolver.ControlFiles {
    ...
    public static class Droplet {
        ...
        //    C.conductMode = BoSSS.Solution.XheatCommon.ConductivityInSpeciesBulk.ConductivityMode.SIP;
        ...
        //    C.ThermalParameters.k_C = 1;
        //    C.ThermalParameters.hVap = 100;
        ...
        //        grd.EdgeTagNames.Add(3, "wall_ConstantHeatFlux_left");
        ...
        //    //}
        //    double Phi(double[] X) {
        //        return ((X[0] - 0.0).Pow2() + (X[1] - 1.1).Pow2()) - 2.25;
        //    }
        ...
        //    C.InitialValues_Evaluators.Add("Temperature#B", X => 100.0);
        //    C.InitialValues_Evaluators.Add("Temperature#C", X => 1.0);
        ...
        //    Func<double[], double> Phi1Func = (X => -(X[1] + 1.0));
        ...
        static class Constants {
            ...
            public static double ST = L - 1e-4;//0.03;//0.01;
