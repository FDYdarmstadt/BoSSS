...
namespace HFSISolver.ControlFiles {
    ...
    public static class HardCodedControl {
        ...
        public static HFSI_Control Channel(int p = 3, int kelem = 5, int AMRlvl = 0) {
        ...
        public static HFSI_Control DynamicChannel(int p = 2, int kelem = 5, int AMRlvl = 0) {
            HFSI_Control C = new HFSI_Control(p);
            C.ImmediatePlotPeriod = 1;
            C.SuperSampling = 3;
            C.AgglomerationThreshold = 0.3;
        ...
        public static HFSI_Control AcceleratedBallInChannel(int p = 2, int kelem = 4) {
            HFSI_Control C = new HFSI_Control(p);
            C.ImmediatePlotPeriod = 1;
            C.SuperSampling = 3;
            C.AgglomerationThreshold = 0.3;
        ...
        public static HFSI_Control BallInChannel(int p = 2, int kelem = 4)
        {
            HFSI_Control C = new HFSI_Control(p);
            C.ImmediatePlotPeriod = 1;
            C.SuperSampling = 3;
