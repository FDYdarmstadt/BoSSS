...
namespace BoSSS.Application.XNSEC {
    ...
    /// </summary>
    internal class HeatConductivityTest : IXNSECTest_Heat {
        private double v;
        ...
        public double[] AcceptableL2Error => new double[] { 1.0e-7, 1.0e-7, 1.0e-7, 1.0e-7, 1.0e-7 };

        public double[] AcceptableResidual => new double[] { 1.0e-7, 1.0e-7, 1.0e-7, 1.0e-7, 1.0e-7 };
        ...
        public GridCommons CreateGrid(int Resolution) {
            ...
            grd.EdgeTagNames.Add(1, "NoSlipNeumann_top");
            grd.EdgeTagNames.Add(2, "NoSlipNeumann_bottom");
        ...
        private double T_l = 0.0, T_r = 1.0;
        ...
        public IDictionary<string, AppControl.BoundaryValueCollection> GetBoundaryConfig() {
            ...
            config.Add("NoSlipNeumann_top", new AppControl.BoundaryValueCollection());
            config.Add("NoSlipNeumann_bottom", new AppControl.BoundaryValueCollection());
    ...
    ///// </summary>
    //class HeatDecayTest : IXNSECTest_Heat{
