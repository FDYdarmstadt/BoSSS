...
namespace AdvancedSolverTests {
    ...
    class SubBlockTestSolver : Application {
        ...
        protected override IGrid CreateOrLoadGrid() {
            ...
            m_grid = Grid2D.Cartesian2DGrid(GenericBlas.Linspace(-1, 1, 6), GenericBlas.Linspace(-1, 1, 6));
            return m_grid;
        }
        ...
        protected override void CreateEquationsAndSolvers(GridUpdateDataVaultBase L) {
            ...
            switch (m_Mshape) {
                ...
                case MatrixShape.diagnoal_spec:
                    ...
                    //Op.EquationComponents["c2"].Add(new SourceTest("u1", 3)); // Flux in Bulk Phase;
        ...
        MultigridOperator.ChangeOfBasisConfig[][] OpConfig {
            get {
                int p = this.u1.Basis.Degree;
                return new MultigridOperator.ChangeOfBasisConfig[][] {
                    new MultigridOperator.ChangeOfBasisConfig[] {
                        new MultigridOperator.ChangeOfBasisConfig() { VarIndex = new int[] { 0 }, mode = MultigridOperator.Mode.SymPart_DiagBlockEquilib, DegreeS = new int[] { p } }
                    }
                };
            }
        }
        ...
        protected override double RunSolverOneStep(int TimestepNo, double phystime, double dt) {
            ...
            var MultigridOp = new MultigridOperator(XAggB, map,
                    OperatorMatrix,
