...
namespace ZwoLevelSetSolver.Boundary {
    ...
    class SolidMomentumConvectionForm : ILevelSetForm {
        int m_iLevSet;
        double m_rho;
        string m_FluidSpc;
        string m_SolidSpecies;
        ...
        public SolidMomentumConvectionForm(string variableName, double rho, int _D, int iLevSet, string FluidSpc, string SolidSpecies) {
            m_D = _D;
            m_iLevSet = iLevSet;
            m_SolidSpecies = SolidSpecies;
            m_FluidSpc = FluidSpc;
        ...
        public double InnerEdgeForm(ref CommonParams inp, double[] uIn, double[] uOut, double[,] Grad_uIN, double[,] Grad_uOut, double vIn, double vOut, double[] Grad_vIN, double[] Grad_vOUT) {
            ...
            if(m_D == 3) {
                r += uOut[0] * (inp.Parameters_OUT[2] + inp.Parameters_IN[2]) * inp.Normal[2];
            }
