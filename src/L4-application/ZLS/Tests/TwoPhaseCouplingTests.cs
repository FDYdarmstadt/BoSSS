...
namespace ZwoLevelSetSolver.Tests
{
    ...
    public class TwoPhaseCouplingTests
    {
        ...
        public static void SolidBallInChannel([Values(2)] int p = 2,
            ...
            //var C = ZwoLevelSetSolver.ControlFiles.HardCodedControl.BallInChannel(p, res);
            //var C = ZwoLevelSetSolver.ControlFiles.HardCodedControl.DynamicChannel(p, res);
            //var C = ZwoLevelSetSolver.ControlFiles.HardCodedControl.Channel(p, res);
