...
namespace ZwoLevelSetSolver.Tests {
    ...
    /// </summary>
    [TestFixture]
    static public class TwoPhaseConvergenceTestsNavierSlip {


        //[Test]
        public static void FluidSolidTaylorCouetteNavierSlip_Experimental_P1() {
            Experimental(1);
        }
        //[Test]
        public static void FluidSolidTaylorCouetteNavierSlip_Experimental_P2() {
            Experimental(2);
        }
        //[Test]
        public static void FluidSolidTaylorCouetteNavierSlip_Exact_P1() {
            Exact(1);
        }
        //[Test]
        public static void FluidSolidTaylorCouetteNavierSlip_Exact_P2() {
            Exact(2);
        }
        //[Test]
        public static void FluidSolidTaylorCouetteNavierSlip_Exact_P3() {
            Exact(3);
        }
        //[Test]
        public static void FluidSolidTaylorCouetteNavierSlip_Exact_P4() {
            Exact(4);
        }
        ...
        public static void Experimental(int p = 2) {
            ...
            var Tst = new FSTaylorCouetteNavierSlip();
