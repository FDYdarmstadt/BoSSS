...
namespace ZwoLevelSetSolver.Tests {
    public static class FSTC {
        ...
        public static ZLS_Control Circle(int p = 2, int h = 3, int AMRlvl = 0, double BeamDensity = 0.1) {
            ...
            // ===================
            #region BC
            C.AddBoundaryValue("wall_lower", "VelocityX", (X, t) => InletVelocityX(X, t, A1, B1));
            C.AddBoundaryValue("wall_lower", "VelocityY", (X, t) => InletVelocityY(X, t, A1, B1));
            C.AddBoundaryValue("wall_upper", "VelocityX", (X, t) => InletVelocityX(X, t, A1, B1));
            C.AddBoundaryValue("wall_upper", "VelocityY", (X, t) => InletVelocityY(X, t, A1, B1));
            C.AddBoundaryValue("wall_left", "VelocityX", (X, t) => InletVelocityX(X, t, A1, B1));
            C.AddBoundaryValue("wall_left", "VelocityY", (X, t) => InletVelocityY(X, t, A1, B1));
            C.AddBoundaryValue("wall_right", "VelocityX", (X, t) => InletVelocityX(X, t, A1, B1));
            C.AddBoundaryValue("wall_right", "VelocityY", (X, t) => InletVelocityY(X, t, A1, B1));
            C.AddBoundaryValue("wall_inside", "DisplacementX", (X, t) => PreDisplacementX(X, t, A2, B2));
            C.AddBoundaryValue("wall_inside", "DisplacementY", (X, t) => PreDisplacementY(X, t, A2, B2));
            #endregion
        ...
        public static ZLS_Control SmallCircle(IZLSTest tst, int p = 2, int h = 3, int AMRlvl = 0, double BeamDensity = 0.1) {
            ...
            C.PhysicalParameters.betaS_A = C.PhysicalParameters.mu_A / 0.0;
            ...
            // ===================
            #region BC
            C.AddBoundaryValue("wall_lower", "VelocityX", X => InletVelocityX(X, A1, B1));
            C.AddBoundaryValue("wall_lower", "VelocityY", X => InletVelocityY(X, A1, B1));
            C.AddBoundaryValue("wall_upper", "VelocityX", X => InletVelocityX(X, A1, B1));
            C.AddBoundaryValue("wall_upper", "VelocityY", X => InletVelocityY(X, A1, B1));
            C.AddBoundaryValue("wall_left", "VelocityX", X => InletVelocityX(X, A1, B1));
            C.AddBoundaryValue("wall_left", "VelocityY", X => InletVelocityY(X, A1, B1));
            C.AddBoundaryValue("wall_right", "VelocityX", X => InletVelocityX(X, A1, B1));
        ...
        public static ZLS_Control SmallCircleNavierSlip(IZLSTest tst, int p = 2, int h = 3, int AMRlvl = 0, double BeamDensity = 0.1) {
            ZLS_Control C = new ZLS_Control(p);
            C.ImmediatePlotPeriod = 1;
            C.SuperSampling = 3;
            C.AgglomerationThreshold = 0.2;
            ...
            C.PhysicalParameters.betaS_A = C.PhysicalParameters.mu_A / 5e-1;
            C.PhysicalParameters.betaS_B = C.PhysicalParameters.betaS_A;

            C.PhysicalParameters.IncludeConvection = true;
            C.PhysicalParameters.Material = false;

            C.Material = new Solid {
                Viscosity = C.PhysicalParameters.mu_A,
                Lame2 = 10,
                Density = BeamDensity
            };
            #endregion
            ...
            //C.InitialValues_Evaluators.Add(VariableNames.SolidLevelSetCG, Phi1Func);
            C.AddInitialValue("Phi2", "X => -(X[1] * X[1] + X[0] * X[0] - (1 + 0.25 * Math.Sqrt(2)) * (1 + 0.25 * Math.Sqrt(2)));", TimeDependent: false);

            //double A1 = 0.989246814183938;
            //double B1 = -1.956987256735753;
            //double A2 = 0.150775722130773;
            //double B2 = -0.037693930532693;

            //double A1 = 0.871863705195938;
            //double B1 = -1.487454820783754;
            //double A2 = 0.123392089093746;
            //double B2 = -0.030848022273437;
            double A1 = 0.678809192607663;
            double B1 = -0.715236770430651;
            double A2 = 0.078355507813557;
            double B2 = -0.019588876953389;
        ...
        public static ZLS_Control SmallCircleFreeSlip(IZLSTest tst, int p = 2, int h = 3, int AMRlvl = 0, double BeamDensity = 0.1) {
            ZLS_Control C = new ZLS_Control(p);
            C.ImmediatePlotPeriod = 1;
            C.SuperSampling = 3;
            C.AgglomerationThreshold = 0.2;
            ...
            //double A2 = 0.123392089093746;
            //double B2 = -0.030848022273437;
            double A1 = 0.500000000000000;
            double B1 = 0.000000000000000;
            double A2 = 0.036642135623731;
            double B2 = -0.009160533905933;
        ...
        public static ZLS_Control CouetteNavierSlip(int p = 2, int h = 1, int AMRlvl = 0, double BeamDensity = 0.1) {
            ZLS_Control C = new ZLS_Control(p);
            C.ImmediatePlotPeriod = 1;
            C.SuperSampling = 3;
            C.AgglomerationThreshold = 0.2;
            ...
            C.GridFunc = delegate () {
                ...
                double[] Xnodes = GenericBlas.Linspace(xLeft, xRight, 4);
                double[] Ynodes = GenericBlas.Linspace(yBottom, yTop, 4);
            ...
            // ===================
            #region BC
            C.AddBoundaryValue("wall_lower", "VelocityX", X => 0.0);
            C.AddBoundaryValue("wall_lower", "VelocityY", X => 0.0);
            C.AddBoundaryValue("wall_upper", "VelocityX", X => 1.0);
            C.AddBoundaryValue("wall_upper", "VelocityY", X => 0.0);
        ...
        public static ZLS_Control CircleCircle(int p = 2, int h = 3, int AMRlvl = 0, double BeamDensity = 0.1) {
            ZLS_Control C = new ZLS_Control(p);
            C.ImmediatePlotPeriod = 1;
            C.SuperSampling = 3;
            C.AgglomerationThreshold = 0.2;
