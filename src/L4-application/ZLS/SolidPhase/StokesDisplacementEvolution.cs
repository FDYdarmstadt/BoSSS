...
namespace ZwoLevelSetSolver.SolidPhase {
    class StokesDisplacementEvolution : BulkEquation {

        string speciesName;

        string codomainName;

        public StokesDisplacementEvolution(string speciesName, int d, int D) {
            ...
            var convection = new StokesTransportForm(speciesName, ZwoLevelSetSolver.VariableNames.DisplacementVector(D), d, D, 1.0);
