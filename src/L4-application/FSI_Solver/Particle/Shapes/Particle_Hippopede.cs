...
namespace BoSSS.Application.FSI_Solver {
    ...
    public class Particle_Hippopede : Particle {
        ...
        public Particle_Hippopede(double length, double thickness, double[] startPos = null, double startAngl = 0, double[] startTransVelocity = null, double startRotVelocity = 0) : base(startPos, startAngl, startTransVelocity, startRotVelocity) {
            length_P = length;
