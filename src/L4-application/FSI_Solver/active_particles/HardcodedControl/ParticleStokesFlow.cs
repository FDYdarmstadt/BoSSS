...
namespace BoSSS.Application.FSI_Solver
{
    ...
    {
        public static FSI_Control ParticleUnderGravity(int k = 2)
        {
            ...
            {
                C.Particles.Add(new Particle_Ellipsoid(new double[] { 0, 14 }, startAngl: 10)
                {
        ...
        public static FSI_Control TwoParticleUnderGravity(int k = 2, double cellAgg = 0.2, double muA = 1e4, double timestepX = 1e-3)
        {
            ...
            C.Particles.Add(new Particle_Sphere(new double[] { 0, 12 }, startAngl: 0)
            {
                particleDensity = 2,
                radius_P = 0.5,
                GravityVertical = -9.81e2,
        ...
        public static FSI_Control ActiveParticles_Cylinder(int k = 2)
        {
            FSI_Control C = new FSI_Control();
            ...
            for (int d = 0; d < numOfParticles; d++)
            {
                C.Particles.Add(new Particle_Ellipsoid(new double[] { -6, -2 + 1 * d }, startAngl: 0)
                {
                    particleDensity = 50,
                    length_P = 0.5,
                    thickness_P = 0.2,
            ...
            C.LinearSolver.MaxSolverIterations = 1000;
            C.LinearSolver.MinSolverIterations = 1;
            C.ForceAndTorque_ConvergenceCriterion = 5e-2;
            C.LSunderrelax = 1.0;
