...
//            {
//                C.Particles.Add(new Particle_Sphere(new ParticleMotion(C.gravity, C.pureDryCollisions, true, true, )1, new double[] { 0 + 14 * d, 0.0 }, startAngl: 180 * d)
//                {
//                    particleDensity = 1.5,
...
//            // Particles
//            // =========
//            C.Particles.Add(new Particle_Sphere(0.4, new double[] { -0.5, -0.5 }, startAngl: 90.0)
//            {
//                particleDensity = 1.0,
//                radius_P = 0.4
//            });
