...
namespace CNS {
    ...
    public static class ControlExamples {
        ...
        public static CNSControl ShockTube_HilbertTest(string SessionID= "eb928188-3c45-44ca-a320-83631b6ff1cb", string GridID= "b153789d-80ab-4938-abf6-0d6bb4bbc50c", string dbPath = null, int dgDegree = 2, int numOfCellsX = 10, int numOfCellsY = 10, double sensorLimit = 1e-4, bool true1D = false, bool saveToDb = true) {
