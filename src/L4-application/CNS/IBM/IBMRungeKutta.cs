...
namespace CNS.IBM {
    ...
    public abstract class IBMRungeKutta : RungeKutta {
        ...
        protected void UpdateEvaluatorsAndMasks() {
            ...
            CellQuadratureScheme volumeScheme = speciesMap.QuadSchemeHelper.GetVolumeQuadScheme(species, true, fluidCells);

            // Does _not_ include agglomerated edges
            EdgeMask nonVoidEdges = speciesMap.QuadSchemeHelper.GetEdgeMask(species);
            EdgeQuadratureScheme edgeScheme = speciesMap.QuadSchemeHelper.GetEdgeQuadScheme(species, true, nonVoidEdges);
            ...
            CellQuadratureScheme boundaryVolumeScheme = speciesMap.QuadSchemeHelper.GetLevelSetQuadScheme(0, cutCells);
