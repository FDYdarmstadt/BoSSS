...
namespace BoSSS.Application.CutCellQuadratureScaling {
    ...
    static class CutCellQuadratureScalingMain {
        ...
        static XQuadFactoryHelper.MomentFittingVariants quadratureType = XQuadFactoryHelper.MomentFittingVariants.Saye;
        static int order = 6;
    ...
    class TestSetupSingleLevset2D : TestSetupSingleLevSetBase {
        ...
        protected override double threshold_totSurface {
            get {
                ...
                if (QuadratureType == XQuadFactoryHelperBase.MomentFittingVariants.Classic) {
                ...
                if (QuadratureType == XQuadFactoryHelperBase.MomentFittingVariants.Saye) {
                    if (this.CutCellQuadratureOrder <= 4) {
                        return 1e-2;
                    } else if (this.CutCellQuadratureOrder <= 7) {
                        return 1e-5;
                ...
                if (QuadratureType == XQuadFactoryHelperBase.MomentFittingVariants.OneStepGaussAndStokes) {
                    if (this.CutCellQuadratureOrder <= 4) {
                        return 1e-7;
                    } else if (this.CutCellQuadratureOrder <= 7) {
                        return 1e-9;
    ...
    /// <summary>
    /// The 3D testcase is an extrusion (yes!) in z-direction of the 2D testcase, i.e., the circle from the 2D testcase is extruded into a cylinder.
