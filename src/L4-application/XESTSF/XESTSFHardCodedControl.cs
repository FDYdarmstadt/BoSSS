...
namespace XESTSF {
    public static class XESTSFHardCodedControl {
        ...
        GetLevelSet shocksetup = GetLevelSet.FromParams, OptiLevelSetType optiLevelSetType = OptiLevelSetType.SplineLevelSet, int optiLSDegree = 1,
        GetInitialValue initialValue = GetInitialValue.FromFunctionPerSpecies, double agg = 0.4, GlobalizationStrategy globalization = ApplicationWithIDT.GlobalizationStrategy.LineSearch, MeritFunctionType meritFunctionType = MeritFunctionType.L2Merit
        ) {
            var c = new XESTSFControl();
