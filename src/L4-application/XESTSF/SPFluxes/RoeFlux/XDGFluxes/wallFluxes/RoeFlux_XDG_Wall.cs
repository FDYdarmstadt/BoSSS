...
namespace XESTSF.Fluxes {
    public class RoeSTFlux_XDG_Wall : ILevelSetForm, ISupportsJacobianComponent,IEquationComponentChecking {
        ...
        public RoeSTFlux_XDG_Wall(LevelSetTracker levelSetTracker, IBoundaryConditionMap boundaryConditionMap, Material material, FluxVariables flux, int component, int levelSetIndex , string posSpecies , string negSpecies , double s_alpha, int D=2) {
