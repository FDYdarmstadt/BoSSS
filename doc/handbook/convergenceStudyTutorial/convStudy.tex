...
/// few formattings to make the multiplot look nicer:
...
multiplot[1,1].LogY2 = true;\newline 
 \newline 
// set x ranges\newline 
multiplot[0,0].X2rangeMin = 1e1;\newline 
multiplot[0,0].X2rangeMax = 1e4;\newline 
multiplot[0,1].X2rangeMin = 1e1;\newline 
multiplot[0,1].X2rangeMax = 1e4;\newline 
 \newline 
multiplot[1,0].XrangeMin = 1e1;\newline 
multiplot[1,0].XrangeMax = 1e4;\newline 
multiplot[1,1].XrangeMin = 1e1;\newline 
multiplot[1,1].XrangeMax = 1e4;\newline 
 \newline 
// set y ranges\newline 
