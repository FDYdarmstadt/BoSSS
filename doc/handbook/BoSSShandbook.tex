...
\begin{figure}[!h]
\begin{center}
\includegraphics[height=0.4\textwidth]{figures/Bubble_t0}
\includegraphics[height=0.4\textwidth]{figures/Bubble_t1}
\includegraphics[height=0.4\textwidth]{figures/Bubble_t2}
\includegraphics[height=0.4\textwidth]{figures/Bubble_t3}
\end{center}
\caption{
...
The workflow management tools (see chapter \ref{sec:BoSSSshell.WorkflowMgm}) of \BoSSSpad 
...
% ################################################################################
\chapter{Further options for Initial Values}
...
\label{sec:BoSSSshell.WorkflowMgm}
% ################################################################################
...
% ################################################################################
\import{./convergenceStudyTutorial/}{convStudy.tex}
...
% ################################################################################
\import{./apdx-MPISolverPerformance/}{MPISolverPerformance.tex}
...
\bibitem{OpenSoftwarePDE} Kummer, F., Weber, J., Smuda, M., 2020. BoSSS: A package for multigrid extended discontinuous Galerkin methods. Computers & Mathematics with Applications. https://doi.org/10.1016/j.camwa.2020.05.001
\end{thebibliography}
\end{refsection}
