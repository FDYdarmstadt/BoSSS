...
As a reference, we recommend the textbook of \cite{DiPietroErn2011},
...
section \ref{sec:Installation}, we will thus 
=========
...
This manual is not intended to be an introduction into the \ac{dg} method.

% --------------------------------------------------------------------------------
\section{\BoSSS{} -related scientific publications}
% --------------------------------------------------------------------------------

\subsection{Peer-reviewed publications}
Articles which have been published or officially accepted by publication outlets with scientific
quality assurance and book publications.

\begin{itemize}
\item
\bibentry{UtzKummerExtVel17}

\item
\bibentry{KummerEtAlXDGTimestepping2017}

\item
\bibentry{UtzEtAlXDG2017}

\item
\bibentry{krauseKummer_IBM_2017}

\item
\bibentry{UtzKummerReinit16}

\item
\bibentry{Niroobakhsh2016}

\item
\bibentry{MuellerEtAl_ibm_2016}

\item
\bibentry{kummerXNSE2015}

\item
\bibentry{klein_high-order_2015}

\item
\bibentry{KummerPatchRecovery2015}

\item
\bibentry{KleinEtAlSimple2015}

\item
\bibentry{muller_hmf_2013}

\item
\bibentry{kummer_extension_2013}

\item
\bibentry{klein_simple_2013}

\item
\bibentry{SFB_finalReport}

\item
\bibentry{mueller_2012}
...
\item
\bibentry{KallendorfThesis2016}

\item
\bibentry{HauThesis2017}

\item
\bibentry{kummer_bosss_2012_thesis}

\item
\bibentry{mullerPhdThesis2014}

\item
\bibentry{kleinPhdThesis2015}

\item
\bibentry{MousaviPhdThesis2014}

\item
\bibentry{EmamyPhdThesis2014}
...
\subsection{Master and Bachelor thesis}
...
\item
\bibentry{ashoori2009}

\item
\bibentry{mullerBscThesis2012}
