...
\begin{itemize}
	...
	\item Obtain/install/load BLAS and LAPACK (tested with AMD Core Math Library 5.3.1)
        \item Dowload native libraries from \url{https://1drv.ms/u/s!ApHj99AUWCA9gfwY71lDOnGahY2ySQ?e=IZIFTs} and unpack into the folder \code{\$BoSSS\_INSTALL} (you may have to set
