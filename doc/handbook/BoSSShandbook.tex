...
& \text{in}\ \Omega = (-5,10) \times (-5,5) \times (-5,5)  & \\
 \vec{u}_D & = & 0                             
& \text{on}\ \Gamma_D = \{ (x,y,z) \in \real^3; \ z = -5,5 \} 
& \text{Dirichlet-boundary}\\
 \vec{u}_S & = & 0                             
...
\graphicspath{{./apdx-MPISolverPerformance/NSESphere/plots/}}

\begin{figure}[!h]
	\begin{center}
	%	\input{./apdx-MPISolverPerformance/NSESphere/plots/MPIScalingTimes.tex}
At Krause: fix this!
	\end{center}
	\caption{
...
\graphicspath{{./apdx-MPISolverPerformance/NSESphereComplex/plots/}}

\begin{figure}[!h]
	\begin{center}
	%	\input{./apdx-MPISolverPerformance/NSESphereComplex/plots/MPIScalingTimes.tex}
        At Krause: fix this!
	\end{center}
	\caption{
