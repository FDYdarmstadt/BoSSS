...
\BoSSSopen{ue5NumFluxConv/ue5NumFluxConv}
\graphicspath{{ue5NumFluxConv/ue5NumFluxConv.texbatch/}}
...
\btab delegate(double Uin, double Uout, Vector n, Vector velocityVector) \{     \newline 
 \newline 
...
class ScalarTransportFlux : NonlinearFlux \{     \newline 
 \newline 
\btab private Func<double, double, Vector, Vector, double> numericalFlux;     \newline 
 \newline 
\btab // Provides instances of this class with a specific flux implementation     \newline 
\btab public ScalarTransportFlux(     \newline 
\btab \btab Func<double, double, Vector, Vector, double> numericalFlux) \{     \newline 
 \newline 
