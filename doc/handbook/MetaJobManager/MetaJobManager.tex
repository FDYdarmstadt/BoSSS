...
\btab try \{\newline 
\btab \btab System.IO.Directory.Delete(@"C:\textbackslash tmp\textbackslash TutorialLocal\_db",true);\newline 
\btab \} catch(Exception) \{ \}\newline 
\}\newline 
if(System.IO.Directory.Exists(@"C:\textbackslash tmp\textbackslash deploy"))\{\newline 
\btab try \{\newline 
\btab \btab System.IO.Directory.Delete(@"C:\textbackslash tmp\textbackslash deploy",true);\newline 
\btab \} catch(Exception) \{ \}\newline 
 \newline 
\}
 }
