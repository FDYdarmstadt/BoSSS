...
\BoSSSexe
\BoSSScmd{
/// We have to pick a batch systems that we want to use:
/// Normally, these are configured in the 
/// {\tt $\sim$/.BoSSS/etc/BatchProcessorConfig.json}-file and 
...
WorkflowMgm.BlockUntilAllJobsTerminate(3600);
 }
\BoSSSexe
\BoSSScmd{
