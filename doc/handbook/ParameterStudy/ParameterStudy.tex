...
\BoSSSexeSilent
\BoSSScmd{
///After the velocities and boundary conditions are set. We need to determine all other simulation parameters needed to proceed. The variable $"ctrl"$ helps to skip the whole name $IBM Control()$. All other parameters are selfexplanatory.
 }
\BoSSSexeSilent
\BoSSScmd{
