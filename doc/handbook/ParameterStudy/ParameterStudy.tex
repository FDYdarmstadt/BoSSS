...
\BoSSSexeSilent
\BoSSScmd{
/// The last part of the initialization is to set up processors. Here, we have two choices - either we do the calculations locally $(\code{myBatch})$ or on the network cluster $(\code{myHPC})$. 
