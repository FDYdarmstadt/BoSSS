...
///\begin{itemize}
/// \item definition of fluxes, chapter 8
/// \item grid generation, chapter 7
/// \item basics of convergence studies, chapter 7
///\end{itemize}
///Within this tutorial the Lax-Friedrichs flux will be implemented as an alternative to the Upwind flux (see chapter 8). 
/// For both fluxes a convergence study will be performed and the "experimental order of convergence" (EOC) will be computed. 
///For the implementation of the Lax-Friedrichs flux and the Upwind flux it is recommended to work through chapter 8 first 
/// as the definition of fluxes is explained there in more detail. For the second part of the tutorial, 
/// chapter 7 has already taught the basics of doing a convergence study.
///
...
\BoSSScmd{
/// %=============================================
/// \subsection{Convergence study}\label{sec:NumFlux_convergence}
/// %=============================================
 }
\BoSSSexe
\BoSSScmd{
