...
\BoSSScmd{
///\label{chap:scalarConvection}
///\section*{What's new}
///\label{sec:scalarConvection_new}
///\begin{itemize}
...
///\label{sec:scalarConvection_prereq}
///\begin{itemize}
/// \item Implementation of fluxes (Tutorials 4 and 5)
/// \item Explicit time integration (Tutorial 4)
/// \item Basics of convergence studies (Tutorial 2 and 5)
...
\BoSSSexe
\BoSSScmd{
/// \subsubsection{Stability region of the fourth order Runge-Kutta scheme}\label{sec:scalarConvection_RK4}
 }
\BoSSSexe
\BoSSScmd{
