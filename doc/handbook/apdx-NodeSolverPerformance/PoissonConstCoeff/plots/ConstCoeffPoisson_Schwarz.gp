...
set termoption dashed
set termoption dashed
plot "ConstCoeffPoisson_Schwarz_data_10.csv" title "Slv Iter" with linespoints linecolor  "black" dashtype 3 linewidth 3 pointtype 6 pointsize 0.5, "ConstCoeffPoisson_Schwarz_data_11.csv" title "Slv Init" with linespoints linecolor  "black" dashtype 2 linewidth 3 pointtype 4 pointsize 0.5, "ConstCoeffPoisson_Schwarz_data_12.csv" title "Agg Init" with linespoints linecolor  "black" dashtype 4 linewidth 3 pointtype 12 pointsize 0.5, "ConstCoeffPoisson_Schwarz_data_13.csv" title "Mtx ass" with linespoints linecolor  "black" dashtype 5 linewidth 3 pointtype 10 pointsize 0.5, "ConstCoeffPoisson_Schwarz_data_14.csv" title "linear" with lines linecolor  "black" dashtype 1 linewidth 1
