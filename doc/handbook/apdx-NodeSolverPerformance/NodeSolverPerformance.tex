...
%\newcommand{\measure}[2]{\mathrm{Vol}_{{#1}} \left( {#2} \right)}
%\newcommand{\GridCells}{\mathfrak{K}_h}
%\newcommand{\nat}{\mathbb{N}}
%\newcommand{\charfunc}{{\chi}}
%%\newcommand{\charfunc}{\upchi}
%\newcommand{\jump}[1]{\left\llbracket {#1} \right\rrbracket}
%%\newcommand{\jump}[1]{\left[\!\left[{{#1}}\right]\!\right]}
%\newcommand{\mean}[1]{\left\{\!\left\{{#1}\right\}\!\right\}}
%\newcommand{\varDeltat}{\triangle}
%\newcommand{\dV}{\ \mathrm{dV} }
%\newcommand{\dl}{{ \ \mathrm{d} \ell}}
%\newcommand{\Kref}{K_{\mathrm{ref}}}
%%\renewcommand{\vec}[1]{\boldsymbol{#1}}
%\newcommand{\divergence}[1]{{\mathrm{div}\left({#1}\right)}}
%\newcommand{\divergenceh}[1]{{\mathrm{div}_h\left({#1}\right)}}
%\newcommand{\reynolds}{{\mathrm{Re}}}
%\newcommand{\MachNo}{{\mathrm{Ma}}}
%\newcommand{\Proj}{{\mathrm{\textit{Proj}}}}
%\newcommand{\Cut}{{\mathrm{\textit{Cut}}}}
%\newcommand{\cont}{{\mathrm{\textit{Cont}}}}
%%\newcommand{\XDG}[1]{{\mathbb{P}^{X}_{#1}}}
%%\newcommand{\XDGagg}[1]{{\mathbb{P}^{X,\mathrm{agg},\alpha}_{#1}}}
%\newcommand{\DG}[1]{{\mathbb{P}_{#1}}}
%%\newcommand{\XDG}[1]{{\mathbb{P}^{\text{X}}_{#1}}}
%\newcommand{\supp}[1]{\mathrm{supp}{ \left( { #1 } \right)}}
%\newcommand{\Mass}{{M_{\mathrm{mass}}}}
%\newcommand{\cM}[1]{\mathcal{M}_{ #1 }}
%\newcommand{\Mop}{\cM{\mathrm{nse}}}
%\newcommand{\cMI}[1]{\cM{ #1 }^{\frakI}}
%\newcommand{\dS}{{ \ \mathrm{dS} }}
%\newcommand{\dt}{{ \ \mathrm{d}t }}
%\newcommand{\GammaInt}{{\Gamma_{\mathrm{int}}}}
%\newcommand{\GammaDiri}{{\Gamma_\mathrm{D}}}
%\newcommand{\GammaNeu}{{\Gamma_\mathrm{N}}}
%\newcommand{\innen}{{\mathrm{in}}}
%\newcommand{\aussn}{{\mathrm{out}}}
%\newcommand{\fict}{{\mathrm{fict}}}
%\newcommand{\sign}[1]{{\mathrm{sign} \left( { #1 } \right) }}
%\newcommand{\normI}{{\vec{n}_{\frakI}}}
%\newcommand{\normOmega}{{\vec{n}_{\partial \Omega}}}
%\newcommand{\normGamma}{{\vec{n}_{\Gamma}}}
%\newcommand{\normGammaI}{{\vec{n}_{\frakI,\Gamma}}}
%\newcommand{\Cp}{{{\mathrm{\textit{Cp}}}}}
%\newcommand{\aSIP}[3]{a_{\mathrm{SIP}}^{#1}({#2},{#3}) }
%\newcommand{\nablah}{{\nabla_{h}}}
%\newcommand{\spcFrac}[2]{{\mathrm{fr}_{#1} \left( { #2 } \right)} }
%\newcommand{\intNum}[1]{ {\int^{ \textrm{\textit{num}} }_{#1}} }
%\newcommand{\ointNum}[1]{ {\oint^{ \textrm{\textit{num}} }_{#1}} }
%\newcommand{\exact}{{\mathrm{\it{ex}}}}
%\newcommand{\agg}{\mathrm{agg}}
%\newcommand{\invchol}{\mathrm{chol}^{-1}}
%\newcommand{\NS}{{\mathrm{\it{Ns}}}}
%\newcommand{\rhsNs}{{\mathrm{\it{rhsNs}}}}
%\newcommand{\rhsSt}{{\mathrm{\it{rhsSt}}}}
%\newcommand{\calC}{\mathcal{C}}
%\newcommand{\graph}{{\mathrm{\it{Gr}}}}
%\newcommand{\edges}{{\mathrm{\it{Edg}}}}
%\newcommand{\aggmesh}{{\mathrm{\it{Agg}}}}
%\newcommand{\nI}{\vec{n}_\frakI}
