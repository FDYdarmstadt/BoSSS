...
\BoSSSexe
\BoSSScmd{
var tempDB = OpenOrCreateDatabase("D:\textbackslash \textbackslash tmp\textbackslash \textbackslash fk\_temp\_db");
 }
\BoSSSexe
\BoSSScmd{
// ====================\newline 
...
\BoSSSexe
\BoSSScmd{
var SubTab\_1 = WorkflowMgm.SessionTable.ExtractColumns("DGdegree:T", "Grid:NoOfCells", "solver\_name", "DOFs", "minSolRunT", "maxSolRunT", "NoIter", "Conv", "RegularTerminated");
 }
\BoSSSexe
\BoSSScmd{
var SubTab = SubTab\_1.ExtractRows(delegate(int i, IDictionary<string,object> row) \{\newline 
...
\BoSSSexe
\BoSSScmd{
//var SubTab\_k23 = SubTab.ExtractRows((iRow,Row) => Convert.ToInt64(Row["DGdegree:T"])==2 || Convert.ToInt64(Row["DGdegree:T"])==3);
 }
\BoSSSexe
\BoSSScmd{
//var SubTab\_k45 = SubTab.ExtractRows((iRow,Row) => Convert.ToInt64(Row["DGdegree:T"])==4 || Convert.ToInt64(Row["DGdegree:T"])==5);
 }
\BoSSSexe
\BoSSScmd{
//var SubTab\_k6 = SubTab.ExtractRows((iRow,Row) => Convert.ToInt64(Row["DGdegree:T"])==6);
 }
\BoSSSexe
\BoSSScmd{
...
//    (iRow,Row) => (System.Enum.ToObject(typeof(SolverCodes),Row["solver\_name"])).ToString() + "k" + Row["DGdegree:T"]);
 }
\BoSSSexe
\BoSSScmd{
...
\BoSSSexe
\BoSSScmd{
multiplots.ToGnuplot().PlotCairolatex().WriteMinimalCompileableExample("D:\textbackslash \textbackslash tmp\textbackslash \textbackslash multi.tex");
 }
\BoSSSexe
\BoSSScmd{
