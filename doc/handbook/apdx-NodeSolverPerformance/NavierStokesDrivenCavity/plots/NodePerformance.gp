...
set termoption dashed
set termoption dashed
plot "NodePerformance_data_0.csv" title "Picard Mumps MGLevels1" with linespoints linecolor  "black" dashtype 3 linewidth 3 pointtype 10 pointsize 0.5, "NodePerformance_data_1.csv" title "NewtonGmres Automatic MGLevels2" with linespoints linecolor  "black" dashtype 3 linewidth 3 pointtype 6 pointsize 0.5, "NodePerformance_data_2.csv" title "NewtonGmres Mumps MGLevels1" with linespoints linecolor  "black" dashtype 3 linewidth 3 pointtype 10 pointsize 0.5, "NodePerformance_data_3.csv" title "Newton Mumps MGLevels1" with linespoints linecolor  "black" dashtype 3 linewidth 3 pointtype 10 pointsize 0.5, "NodePerformance_data_4.csv" title "NewtonGmres Swz Kcycle w Coarse Overlap MGLevels2" with linespoints linecolor  "black" dashtype 2 linewidth 3 pointtype 1 pointsize 0.5, "NodePerformance_data_5.csv" title "Picard SoftGMRES Swz Kcycle w Coarse Overlap MGLevels2" with linespoints linecolor  "black" dashtype 4 linewidth 3 pointtype 2 pointsize 0.5
