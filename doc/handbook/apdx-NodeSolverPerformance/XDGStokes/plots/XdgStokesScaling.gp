set output 'XdgStokesScaling.tex'
...
set y2tics format " " 
set termoption dashed
plot "XdgStokesScaling_data_3.csv" title "Kcycle w. add.-schwarz" with linespoints linecolor  "black" dashtype 1 linewidth 3 pointtype 11 pointsize 0.5, "XdgStokesScaling_data_4.csv" title "Pardiso" with linespoints linecolor  "black" dashtype 3 linewidth 3 pointtype 6 pointsize 0.5, "XdgStokesScaling_data_5.csv" title "linear" with lines linecolor  "black" dashtype 1 linewidth 1
set size 0.98,0.326666666666667
